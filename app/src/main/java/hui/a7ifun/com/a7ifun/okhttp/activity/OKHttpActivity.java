package hui.a7ifun.com.a7ifun.okhttp.activity;
...
public class OKHttpActivity extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(hui.a7ifun.com.a7ifun.R.layout.activity_okhttp);
        //初始化
        initView();
    }

    private void initView() {
        btn_get = (Button) findViewById(hui.a7ifun.com.a7ifun.R.id.btn_get);
        btn_post = (Button) findViewById(hui.a7ifun.com.a7ifun.R.id.btn_post);
        btn_get1 = (Button) findViewById(hui.a7ifun.com.a7ifun.R.id.btn_get1);
        btn_post1 = (Button) findViewById(hui.a7ifun.com.a7ifun.R.id.btn_post1);
        btn_download = (Button) findViewById(hui.a7ifun.com.a7ifun.R.id.btn_download);
        btn_downloadimg = (Button) findViewById(hui.a7ifun.com.a7ifun.R.id.btn_downloadimg);
        btn_showInLv = (Button) findViewById(hui.a7ifun.com.a7ifun.R.id.btn_showInLv);

        tv_show = (TextView) findViewById(hui.a7ifun.com.a7ifun.R.id.tv_show);
        tv_title = (TextView) findViewById(hui.a7ifun.com.a7ifun.R.id.tv_title);
        tv_title.setText("OKHttp的简单使用方法");

        iv = (ImageView) findViewById(hui.a7ifun.com.a7ifun.R.id.iv);
        pb = (ProgressBar) findViewById(hui.a7ifun.com.a7ifun.R.id.pb);
        //设置按钮单击监听事件
    ...
    public void onClick(View view) {
        tv_show.setText("");
        switch (view.getId()) {
            case hui.a7ifun.com.a7ifun.R.id.btn_get:
                getDataFromOKHttpGet();
                break;
            case hui.a7ifun.com.a7ifun.R.id.btn_post:
                getDataFromOKHttpPost();
                break;
            case hui.a7ifun.com.a7ifun.R.id.btn_get1:
                getDataFromOKHttpUtilsGet();
                break;
            case hui.a7ifun.com.a7ifun.R.id.btn_post1:
                getDataFromOKHttpUtilsPost();
                break;
            case hui.a7ifun.com.a7ifun.R.id.btn_download:
                downloadFile();
                break;
            case hui.a7ifun.com.a7ifun.R.id.btn_downloadimg:
                downloadImg();
                break;
            case hui.a7ifun.com.a7ifun.R.id.btn_showInLv:
