package hui.a7ifun.com.a7ifun.json.activity;

import hui.a7ifun.com.a7ifun.json.bean.FilmInfo;
import hui.a7ifun.com.a7ifun.json.bean.MovieInfo;
import hui.a7ifun.com.a7ifun.json.bean.ShopInfo;
...
public class NativeJsonParseActivity extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(hui.a7ifun.com.a7ifun.R.layout.activity_native_json_parse);
    ...
    private void initView() {
        btn_jsonObject2JavaObject = (Button) findViewById(hui.a7ifun.com.a7ifun.R.id.btn_jsonObject2JavaObject);
        btn_jsonList2JavaMap = (Button) findViewById(hui.a7ifun.com.a7ifun.R.id.btn_jsonList2JavaMap);
        btn_tjsonparse = (Button) findViewById(hui.a7ifun.com.a7ifun.R.id.btn_tjsonparse);
        btn_sjsonparse = (Button) findViewById(hui.a7ifun.com.a7ifun.R.id.btn_sjsonparse);

        tv_before = (TextView) findViewById(hui.a7ifun.com.a7ifun.R.id.tv_json_before);
        tv_after = (TextView) findViewById(hui.a7ifun.com.a7ifun.R.id.tv_json_after);
    ...
    public void onClick(View view) {
        ...
        tv_after.setText("");
        switch (view.getId()) {
            case hui.a7ifun.com.a7ifun.R.id.btn_jsonObject2JavaObject:
                jsonToJavaObjectByNative();
                break;
            case hui.a7ifun.com.a7ifun.R.id.btn_jsonList2JavaMap:
                jsonToJavaListByNative();
                break;
            case hui.a7ifun.com.a7ifun.R.id.btn_tjsonparse:
                jsonToJavaOfComplex();
                break;
            case hui.a7ifun.com.a7ifun.R.id.btn_sjsonparse:
                jsonToJavaOfSpecial();
                break;
        }
    }
