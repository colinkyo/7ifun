...
import hui.a7ifun.com.a7ifun.adapter.lv_adapter;
...
public class CustomFragment extends BaseFragment {
    ...
    protected View initView()
    {
       ...
       /* textView = new TextView(mContent);
        ...
        return textView;*/
        //创建自己的布局
        View movieView =View.inflate(mContent, hui.a7ifun.com.a7ifun.R.layout.item_movie_ptr_container,null);
        //实例化控件tv_title =movieView.findViewById(R.id.tv_title);
//        实例化下拉刷新类
        mPullToRefreshListView = (PullToRefreshListView) movieView.findViewById(hui.a7ifun.com.a7ifun.R.id.pull_to_refresh);
//        得到ListView对象
