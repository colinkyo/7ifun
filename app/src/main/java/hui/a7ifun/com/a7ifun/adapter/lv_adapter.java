...
public class lv_adapter extends BaseAdapter
{
    ...
    public View getView(int position, View convertView, ViewGroup parent)
    {
        ...
        if (convertView == null)
        {
            ...
            convertView = LayoutInflater.from(mContext).inflate(hui.a7ifun.com.a7ifun.R.layout.item_movie_list, null);

            holder.tv_movie_name = (TextView) convertView.findViewById(hui.a7ifun.com.a7ifun.R.id.tv_movie_name);
