...
public class MyMovieAdapter extends BaseAdapter {
   ...
   //private final ArrayList<Map> mDatas;
    ...
    public View getView(int position, View convertView, ViewGroup parent)
    {
        ...
        if(convertView == null)
        {
            convertView = View.inflate(mContext, hui.a7ifun.com.a7ifun.R.layout.item_movie_list,null);
            viewHodle = new ViewHodle();
            //注意和布局文件的ID 对应好，不然报错
            viewHodle.iv_movie_logo = (ImageView) convertView.findViewById(hui.a7ifun.com.a7ifun.R.id.iv_movie_logo);
            viewHodle.tv_name = (TextView) convertView.findViewById(hui.a7ifun.com.a7ifun.R.id.tv_movie_name);
            viewHodle.tv_time = (TextView) convertView.findViewById(hui.a7ifun.com.a7ifun.R.id.tv_movie_time);
