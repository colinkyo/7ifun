...
//      加载包含PullToRefreshListView控件的布局进来
        View ptrview = View.inflate(mContent, hui.a7ifun.com.a7ifun.R.layout.item_movie_ptr_7ifun_container,null);
        pb_loading = (ProgressBar) ptrview.findViewById(hui.a7ifun.com.a7ifun.R.id.pb_loading);
        tv_nodata = (TextView) ptrview.findViewById(hui.a7ifun.com.a7ifun.R.id.tv_nodata);
        mPullToRefreshListView = (PullToRefreshListView) ptrview.findViewById(hui.a7ifun.com.a7ifun.R.id.pull_to_refresh_7ifun);
