...
//    布局xml文件id
    ...
    private final Map<String,String> para;
    ...
    public MovieFragment(String str, String title, int resid, Map<String,String> para)
    {
        super();
        this.str = str;
        this.title = title;
    ...
    {
        Log.e(TAG,"电影Fragment视图被初始化了....");
       /* textView = new TextView(mContent);
        textView.setTextSize(25);
        textView.setTextColor(Color.GREEN);
        return textView;*/
        View ptrview = View.inflate(mContent,resid,null);
...
//        Toast.makeText(mContent, key + "===" + val, Toast.LENGTH_SHORT).show();
        OkHttpUtils
//                .get()
                .post()
                .addParams("page", page + "")
