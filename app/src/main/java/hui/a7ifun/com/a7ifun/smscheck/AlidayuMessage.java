package hui.a7ifun.com.a7ifun.smscheck;
...
public class AlidayuMessage {
    ...
    private static final String appKey = "23609009";  //你的appkey
    private static final String appSecret = "ac37654e1ef72f8ef5e6e492bd707972"; //你的appSecret
    private static final String sessionKey = "";
    //业务参数
    private static String extend = "";
    private static String sms_type = "normal";
    private static String sms_free_sign_name = "去分享";
