...
import hui.a7ifun.com.a7ifun.adapter.MyMovieNetAdapter;
...
public class ThirdPartyFragment_old extends BaseFragment {
    private static final String TAG = ThirdPartyFragment_old.class.getSimpleName();//"CommonframeFragment"
    ...
    protected View initView()
    {
        ...
        return textView;*/
        //创建自己的布局
        View movieView =View.inflate(mContent, hui.a7ifun.com.a7ifun.R.layout.item_movie_container,null);
        //实例化控件
        iv_movie_list = (ListView) movieView.findViewById(hui.a7ifun.com.a7ifun.R.id.iv_movie_list);
        tv_nodata = (TextView) movieView.findViewById(hui.a7ifun.com.a7ifun.R.id.tv_nodata);
        pb_loading = (ProgressBar) movieView.findViewById(hui.a7ifun.com.a7ifun.R.id.pb_loading);
        return movieView;
    }
