...
public class OKHttpInListViewAdapter extends BaseAdapter {
    ...
    public View getView(int position, View view, ViewGroup viewGroup){
        ...
        if(view == null)
        {
            view = View.inflate(mContext, hui.a7ifun.com.a7ifun.R.layout.item_okhttplistview,null);
            viewHolder = new ViewHolder();
            viewHolder.iv_icon = (ImageView) view.findViewById(hui.a7ifun.com.a7ifun.R.id.iv_icon);
            viewHolder.tv_name = (TextView) view.findViewById(hui.a7ifun.com.a7ifun.R.id.tv_name);
            viewHolder.tv_time = (TextView) view.findViewById(hui.a7ifun.com.a7ifun.R.id.tv_time);
